...
export const GetTodolists = () => {
  ...
  useEffect(() => {
    todolistsAPI.getTDLists().then(res => {
      setState(res.data);
    });
  }, []);
...
export const CreateTodolists = () => {
  ...
  const createTodolistsOnClick = () => {
    todolistsAPI.createTDLists(title).then(res => {
  ...
  return (
    <div>
      ...
      <div>
        <input
          placeholder="Insert new TDList title here"
          value={title}
          onChange={e => {
...
export const DeleteTodolists = () => {
  ...
  const deleteTodolistsOnClick = () => {
    todolistsAPI.deleteTDLists(todolistId).then(res => {
      setState(res.data);
    });
  };
  ...
  return (
    <div>
      ...
      <div>
        <input
          placeholder="Insert TDList ID here"
          value={todolistId}
          onChange={e => {
...
export const UpdateTodolists = () => {
  ...
  const UpdateTodolistsOnClick = () => {
    todolistsAPI.updateTDLists(todolistId, title).then(res => {
      setState(res.data);
    });
  };
...
export const CreateTask = () => {
  ...
  return (
    <div>
      ...
      />
      <input
        placeholder="Insert new task title here"
        value={title}
        onChange={e => {
          setTitle(e.currentTarget.value);
        }}
...
export const DeleteExactTask = () => {
  ...
  return (
    <div>
      ...
      />
      <input
        placeholder="Insert exact task ID here"
        value={taskID}
        onChange={e => {
  ...
  return (
    <div>
      ...
      <ul>
        ...
        <li>
          <input
            placeholder="Insert task deadline here"
            value={deadline!}
            onChange={e => {
        ...
        <li>
          <input
            placeholder="Insert task priority here"
            value={priority}
            onChange={e => {
        ...
        <li>
          <input
            placeholder="Insert task startDate here"
            value={startDate!}
            onChange={e => {
        ...
        <li>
          <input
            placeholder="Insert task status here"
            value={status}
            onChange={e => {
